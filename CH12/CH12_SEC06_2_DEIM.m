...
figure(1)
subplot(2,1,2), plot(x,-real(Psi(:,1:3)))
%legend('mode 1','mode 2','mode 3','Fontsize',[15])

set(gca,'Xlim',[-4 4],'Xtick',[-4 -2 0 2 4],'Ylim',[-0.4 0.4],'Ytick',[-0.4 0 0.4],'Fontsize',[15])
hold on
bar(x,P(:,1:3),'k')
bar(x,-P(:,1:3),'k')
...
subplot(2,1,1), plot(x,-real(Psi(:,1:3)))
%legend('mode 1','mode 2','mode 3','Fontsize',[15])

set(gca,'Xlim',[-2 2],'Xtick',[-4 -2 0 2 4],'Ylim',[-0.4 0.4],'Ytick',[-0.4 0 0.4],'Fontsize',[15])
hold on
bar(x,P(:,1:3),'k')
bar(x,-P(:,1:3),'k')
